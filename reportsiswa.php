...
while($row = mysqli_fetch_array($query))
{
	...
	$sheet->setCellValue('E'.$i, $row['tptlahir']);
	...
	$sheet->setCellValue('J'.$i, $row['berkebutuhan']);
...
$writer->save('Report Data Formulir Siswa.xlsx');
?>